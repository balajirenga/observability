...
import com.country.countryprj.TempClass;
...
import com.country.output.Spangroup;
...
public class HomePulseHandler implements ObservationHandler<Observation.Context> {
    ...
    public void onStart(Observation.Context context) {
       ...
       spanBuilder = tracerObj.spanBuilder(methodName);
      ...
      //  span.addEvent("do some sampleevent", Attributes.of(AttributeKey.longKey("sampleKey"), Long.valueOf(93)));
        ...
        spanGroup.setSpanId(spanId);
        spanGroup.setSpanName(context.getName());
        spanGroup.setTraceId(traceId);

        outputDom.addSpangroup(spanGroup);
        ...
        spanTopping.setAttribute("system Transaction id", TempClass.systemTrxId);
       // spanTopping.makeCurrent();
